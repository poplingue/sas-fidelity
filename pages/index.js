...
export default function Home() {
    ...
    return <div>
        ...
        <button>Mes points de fidélité</button>
        <button id="button">Installer</button>
        {!init && <dialog id="dialog">
            <div id="cancel">fermer</div>
            <br/>
            Pour installer l'application sur votre mobile,<br/>
            parcourez le menu de votre navigateur {icons[isFirefox() ? 'firefox' : 'ios'].menu()} <br/>
            puis
            « {icons[isFirefox() ? 'firefox' : 'ios'].label()} » {icons[isFirefox() ? 'firefox' : 'ios'].install()}
        </dialog>}
